...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex-1 w-full flex flex-col overflow-hidden transition-colors duration-500 ease-in-out">
        <Header />

        <section className="relative flex-1 flex w-full items-center justify-center px-4 sm:px-6 pb-6 pt-4 transition-colors duration-500 ease-in-out">
          <Dropzone
